...
test('login teacher  should login a user', async () => {
    ...
    assert.strictEqual(loggedInUser.email, email, 'teacher email should match');
    assert.strictEqual(userRole, role, 'User role should be teacher');
