...
const HomePage = () => {
  return (
    <div className="homepage-container">
      ...
      <p className="homepage-intro">זהו פרויקט שנוצר על ידי צוות מומחים בטכנולוגיה וחינוך שמטרתו לסייע לתלמידים עם קשיים בלמידה בעזרת כלי בינה מלאכותית מתקדמים.</p>
